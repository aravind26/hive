// ORM class for table 'fy'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Tue Jun 05 04:07:06 PDT 2018
...
public class fy extends SqoopRecord  implements DBWritable, Writable {
  private final int PROTOCOL_VERSION = 3;
  public int getClassFormatVersion() { return PROTOCOL_VERSION; }
  protected ResultSet __cur_result_set;
  private Integer fy_id;
  public Integer get_fy_id() {
    return fy_id;
  }
  public void set_fy_id(Integer fy_id) {
    this.fy_id = fy_id;
  }
  public fy with_fy_id(Integer fy_id) {
    this.fy_id = fy_id;
    return this;
  }
  ...
  public fy with_student_id(Integer student_id) {
    this.student_id = student_id;
    return this;
  }
  ...
  public fy with_result(Double result) {
    this.result = result;
    return this;
  }
  public boolean equals(Object o) {
    ...
    fy that = (fy) o;
    boolean equal = true;
    equal = equal && (this.fy_id == null ? that.fy_id == null : this.fy_id.equals(that.fy_id));
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.fy_id = JdbcWritableBridge.readInteger(1, __dbResults);
    this.student_id = JdbcWritableBridge.readInteger(2, __dbResults);
    this.result = JdbcWritableBridge.readDouble(3, __dbResults);
  }
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    JdbcWritableBridge.writeInteger(fy_id, 1 + __off, 4, __dbStmt);
    JdbcWritableBridge.writeInteger(student_id, 2 + __off, 4, __dbStmt);
    JdbcWritableBridge.writeDouble(result, 3 + __off, 8, __dbStmt);
    return 3;
  }
...
this.readFields0(__dataIn);  }
  public void readFields0(DataInput __dataIn) throws IOException {
    ...
    this.fy_id = Integer.valueOf(__dataIn.readInt());
    }
    if (__dataIn.readBoolean()) { 
  ...
  public String toString(DelimiterSet delimiters, boolean useRecordDelim) {
    ...
    __sb.append(FieldFormatter.escapeAndEnclose(fy_id==null?"null":"" + fy_id, delimiters));
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    try {
    __cur_str = __it.next();
    if (__cur_str.equals("null") || __cur_str.length() == 0) { this.fy_id = null; } else {
      this.fy_id = Integer.valueOf(__cur_str);
    }
  ...
  public void clone0(fy o) throws CloneNotSupportedException {
  }

  public Map<String, Object> getFieldMap() {
    Map<String, Object> __sqoop$field_map = new TreeMap<String, Object>();
    __sqoop$field_map.put("fy_id", this.fy_id);
  ...
  public void setField(String __fieldName, Object __fieldVal) {
    if ("fy_id".equals(__fieldName)) {
      this.fy_id = (Integer) __fieldVal;
    }
